"use client"
import { AppShell, Box, Burger, Container, Flex, Group, Space, Stack, Text } from '@mantine/core'
...
const PADDING_INLINE = { base: 'calc(var(--mantine-spacing-sm) * 2)', lg: 'calc(var(--mantine-spacing-md) * 10)' }
    ...
    return (
        ...
        >
            <AppShell.Header
                ...
                <Container className='full-height' size='lg'>
                    <Stack className='full-height' >
                        <Group pt={{ base: 'lg', lg: 'calc(var(--mantine-spacing-md) * 3)' }} justify='space-between'>
                            ...
                            <Group hiddenFrom='md'>
                                <Burger style={{ zIndex: 9999, position: 'relative' }} opened={opened} onClick={() => alert(2)} variant='outline' color='yellow.6' />
                            </Group>
                        </Group>
